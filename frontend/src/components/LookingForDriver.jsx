    ...
    return (
        <div>
            ...
            <div className='flex gap-2 justify-between flex-col items-center'>
                <img className={`h-16 ${props.vehicleType === 'moto' ? 'h-20' : 'h-16'}`} src={vehicleImages[ props.vehicleType ]} alt="" />
                <div className='w-full mt-2 no-scrollbar overflow-y-auto max-h-[40vh]'>
